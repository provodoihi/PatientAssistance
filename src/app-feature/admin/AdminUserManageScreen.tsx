...
import {pic_userColor, pic_search, pic_edit, pic_remove} from '../../../assets';
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.container2}>
        <Image style={styles.img} source={pic_userColor} />
        ...
        <TouchableOpacity
          ...
          <View style={styles.rowButton}>
            <Image style={styles.iconButton} source={pic_remove} />
