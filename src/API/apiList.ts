export const API_List = {
  ...
  filter: 'http://192.168.1.7:8080/api/public/hospitalclinic/find?keyword=',
  myProfile: 'http://192.168.1.7:8080/api/profile/myProfile',
  appointmentCreate: 'http://192.168.1.7:8080/api/appointments',
  appointmentFindId: 'http://192.168.1.7:8080/api/appointments/',
