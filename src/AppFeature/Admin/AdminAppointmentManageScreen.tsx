  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.container2}>
        <Image
          style={styles.img}
          source={require('../../../assets/Image_Icon/appointment_nocolor.png')}
        />
        <Text style={[styles.txt, styles.txtName]}>Appointment Management</Text>
        <TouchableOpacity
          ...
          <View style={styles.rowButton}>
            <Image
              ...
              source={require('../../../assets/Image_Icon/appointment_nocolor.png')}
            />
            <Text style={styles.txtButton}>List Appointments</Text>
          </View>
        </TouchableOpacity>
        <TouchableOpacity
          style={[styles.button, styles.shadow]}
          ...
          <View style={styles.rowButton}>
            ...
            />
            <Text style={styles.txtButton}>Remove Appointment</Text>
          </View>
        </TouchableOpacity>
      </View>
    </View>
